...
export const updateRequestAdmin = (data: any) => {
    ...
    myHeaders.append(
        'Authorization',
        'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJsYXRydW9uZ2hhaSIsImF1dGhvcml0aWVzIjpbeyJhdXRob3JpdHkiOiJpbWFnZTpyZWFkIn0seyJhdXRob3JpdHkiOiJpbWFnZTp3cml0ZSJ9LHsiYXV0aG9yaXR5IjoiUk9MRV9BRE1JTiJ9XSwiaWF0IjoxNjQ4NTY0MzkwLCJleHAiOjE2NDk3NzM5OTB9.rDvNPRN8I8OoTjqrC0e-I-g4TRDV1U6obm8KAVRXgP7c8QDhVb9-coJffVSfyVDhejkho7mwRja5QmsIGUC9XA'
    );
    myHeaders.append('Content-Type', 'application/json');
    ...
    fetch(
        'http://localhost:8080/admin/api/apartment/update',
...
export async function fetchDataApartment(id: number, callback: any) {
    ...
    try {
        ...
        if (response.status === 200) {
            const dataImageApartment = getImageSlideShowApartmentData(
                response.data.body
            );
            //
            callback(
                slideShowImageHandleAction(
                    ImageHandleActionEnum.GET_ALL_IMAGES,
                    {
