...
export const reactComponentSelectorReducer = (state: ReactComponentElement = { element: <Empty />, typeName: "" }, action: ReactComponentSelectionAction): ReactComponentElement => {
    switch (action.type) {
