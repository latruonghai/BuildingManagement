...
import {
    fetchDataApartment,
    delApartmentImageRequest
} from '../utils/requestHandle';
                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            <div className=" flex justify-between items-center px-4 py-3">
                                <h1 className="modal-title">
                                    {class_name}
                                    <button
                                        className="fas fa-sync relative"
                                        onClick={() => {
                                            fetchDataApartment(
                                                selectorId.idSelector as number,
                                                dispatch
                                            );
                                        }}
                                    />
                            ...
                            <div className="modal-body">
                                <OptionButton
                                    arrayOptionView={optionViewPropertiesArray(
                                        dispatch
                                    )}
                                />
                                {bodyContent ? (
                            ...
                            <div className="modal-footer">
                                <Button
                                    contentButton=" Upload Image"
                                    classNameStyle="fas fa-upload"
                                    onClickHandler={() =>
                                        dispatch(
                                            reactComponentSelectionAction(
                                                ReactComponentSelectionEnum.UPLOAD_VIEW
                                            )
                                        )
                                    }
                                />
                                ...
                                {typeName ===
                                    ...
                                    <Fragment>
                                        ...
                                        <Button
                                            ...
                                            classNameStyle=" fas fa-trash delete"
                                            type="button"
                                            data-dismiss="modal"
                                            onClickHandler={() => {
                                                const index =
                                ...
                                <Button
                                    contentButton=" Close"
                                    classNameStyle="fas fa-times btn decline"
                                    type="button"
                                    data-dismiss="modal"
                                    onClickHandler={() => {
                                        toggle();
